...
{
    return GameStartingIntefrace::create();
}
...
bool GameStartingIntefrace::init()
{
    //////////////////////////////
    // 1. super init first
    if (!Scene::init())
    ...
    {
        problemLoading("'myclose4.png' and 'myclose3.png'");
    }
    else
    {
...
void GameStartingIntefrace::menuCloseCallback(Ref* pSender)
{
